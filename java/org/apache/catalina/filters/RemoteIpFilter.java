...
public class RemoteIpFilter extends GenericFilter {
     ...
     *     </ul>
     * </p>
     * @param netmasks The list of network masks
     */
    public void setInternalProxiesMasks(String netmasks) {
        if (netmasks != null) {
            this.internalProxiesMasks = Arrays.stream(netmasks.split(","))
                .map(NetMask::new)
                .toList();
        }
    }
